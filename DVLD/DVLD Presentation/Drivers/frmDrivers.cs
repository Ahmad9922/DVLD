...
namespace DVLD
{
    public partial class frmDrivers : Form
    {
        ...
        private void ucDriversList_FilterValueChanged(object sender, CustomControls.UCFilter2.ResultEventArgs e)
        {
            ucDriversList.SetList(clsDriver.GetDriversList(e.Value, e.FieldName));
        }
    }
}
