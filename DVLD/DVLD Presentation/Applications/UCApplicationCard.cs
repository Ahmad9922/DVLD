    ...
    public partial class UCApplicationCard : UserControl
    {
        ...
        public void FillApplication(int ApplicationID)
        {
            if ((Application = clsApplication.Find(ApplicationID)) != null)
            {
                ...
                lblApplicationType.Text = Application.ApplicationType.ApplicationTypeTitle;
        ...
        {
            frmPersonCard PersonCardForm = new frmPersonCard(Application.ApplicantPerson.PersonID.Value);
