    ...
    public partial class UCAddLocalDLA : UserControl
    {
        ...
        public void SetLocalDLA(int LocalDLAID)
        {
            if ( (LocalDLA = clsLocalDLA.Find(LocalDLAID)) != null)
            {
                ...
                cbLicenseClasses.SelectedItem = LocalDLA.LicenseClass.ClassName;
        ...
        public void FillApplicationInfo()
        {
            ...
            lblApplicationFeesValue.Text = clsApplicationType.Find
                (clsApplicationType.enApplicationTypeID.NewLocalDrivingLicenseService).ApplicationFees.ToString();
        ...
        private bool IsAgeAllowedForClass()
        {
            short MinimumAllowedAge = clsLicenseClass.Find(
                Convert.ToString(cbLicenseClasses.SelectedItem)).MinimumAllowedAge;
        ...
        private bool InfoValidation()
        {
            ...
            if (clsLocalDLA.IsApplicationRequiredOrCompleted(ucPersonCardWithFilter1.Person.PersonID.Value,
                clsLicenseClass.GetID(Convert.ToString(cbLicenseClasses.SelectedItem))))
            {
        ...
        private void AddLocalDLAInfo()
        {
            ...
            LocalDLA.LicenseClass = clsLicenseClass.Find(cbLicenseClasses.SelectedItem.ToString());
        }
