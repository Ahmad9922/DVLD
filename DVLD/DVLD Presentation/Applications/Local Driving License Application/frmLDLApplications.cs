...
namespace DVLD
{
    public partial class frmLDLApplications : Form
    {
        ...
        private void CancelApplication_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!clsTestAppointment.IsThereAnActiveAppointment(SelectedLocalDLAID, clsTestType.enTestTypeID.Vision))
                {
        ...
        private void tsmiShowPersonLicenseHistory_Click(object sender, EventArgs e)
        {
            frmLicenseHistory LicenseHistoryForm =
                ...
                .ApplicantPerson.PersonID.Value).DriverID.Value);
        ...
        {
            ucListWithFilter.SetList(clsLocalDLA.GetLDLApplications(e.Value, e.FieldName));
        }
    }
}
