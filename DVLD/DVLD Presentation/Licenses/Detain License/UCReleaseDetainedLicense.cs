    ...
    public partial class UCReleaseDetainedLicense : UserControl
    {
        ...
        public void FillInitialInfo()
        {
            lblApplicationFees.Text = clsApplicationType.Find
                (clsApplicationType.enApplicationTypeID.ReleaseDetainedDrivingLicsense).ApplicationFees.ToString();
        ...
        private void btnRelease_Click(object sender, EventArgs e)
        {
                      ...
                      "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                clsApplication Application =
                        ...
                        clsApplicationType.Find(clsApplicationType.enApplicationTypeID.ReleaseDetainedDrivingLicsense), clsGeneralProperties.RegisteredUser);
        ...
        private void FillDetainInfo()
        {
            ...
            lblTotalFees.Text = Convert.ToString(FineFees + clsApplicationType.Find
                (clsApplicationType.enApplicationTypeID.ReleaseDetainedDrivingLicsense).ApplicationFees);
        }
