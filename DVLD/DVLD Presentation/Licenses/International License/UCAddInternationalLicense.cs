...
namespace DVLD
{
    public partial class UCAddInternationalLicense : UserControl
    {
        ...
        public void FillApplicationInfo()
        {
            ...
            lblFees.Text = clsApplicationType.Find(clsApplicationType.enApplicationTypeID.NewInternationalLicense).ApplicationFees.ToString();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (ucLicenseCardWithFilter1.License != null)
            {
                ...
                {
                    if (ucLicenseCardWithFilter1.License.LicenseClass.LicenseClassID == clsLicenseClass.enLicenseClassID.Class3Ordinary)
                    {
                        if (!clsInternationalLicense.IsInternationalDrivingLicenseIssued
                            (ucLicenseCardWithFilter1.License.LicenseID.Value))
                        {
        ...
        private void btnIssue_Click(object sender, EventArgs e)
        {
            if (!clsInternationalLicense.
                IsInternationalDrivingLicenseIssued(ucLicenseCardWithFilter1.License.LicenseID.Value))
            {
                clsApplication Application =
                    new clsApplication(ucLicenseCardWithFilter1.License.Driver.Person,
                    clsApplicationType.Find(clsApplicationType.enApplicationTypeID.NewInternationalLicense),
