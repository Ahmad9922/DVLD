...
namespace DVLD
{
    public partial class frmUpdateAndAddUser : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "FirstTimeSchedule User";
        ...
        private bool IsThePersonAlreadyAUser()
        {
            ...
            if (clsUser.IsPersonExist(ucPersonCardWithFilter1.Person.PersonID.Value))
            {
        ...
        private void btnSaveUser_Click(object sender, EventArgs e)
        {
            if (!IsThePersonAlreadyAUser())
            {
                if (ucAddUser.SaveUser(ucPersonCardWithFilter1.Person.PersonID.Value))
                    this.Close();
            }
        }
